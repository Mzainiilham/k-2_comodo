                            ...
                            <div class="form-group">
                                ...
                                <select name="expense_category_id" id="" class="form-control">
                                    ...
                                    @foreach($expense_categories as $id => $expense_category)
                                        <option {{ $expense->expense_category_id == $id ? 'selected' : null }} value="{{ $id }}">{{ $expense_category }}</option>
                                    @endforeach
                                </select>
                    ...
                    <div class="row">
                        <div class="col">
                            <div class="form-group">
                                ...
                                <input class="form-control" id="entry_date" type="date" name="entry_date" value="{{ old('entry_date', date('Y-m-d', strtotime($expense->entry_date))) }}">
                    ...
                    <div class="row">
                        <div class="col">
                            <div class="form-group">
                                ...
                                <input class="form-control" id="amount" type="number" name="amount" value="{{ old('amount', $expense->amount) }}">
                    ...
                    <div class="row">
                        <div class="col">
                            <div class="form-group">
                                ...
                                <textarea class="form-control" name="description" id="description" cols="30" rows="10">{{ old('description', $expense->description) }}</textarea>
