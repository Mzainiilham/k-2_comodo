...
@section('content')
    <div class="container">
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                <form action="{{ route('admin.expense_categories.update', $expense_category) }}" method="POST">
                    @csrf
                    @method('put')
                    <div class="row">
                        <div class="col">
                            <div class="form-group">
                                ...
                                <input class="form-control" id="name" type="text" name="name" value="{{ old('name', $expense_category->name) }}">
